...
class DataLoader:
    def __init__(self, data):
        self.cfg = {
            'movie20': {
                ...
                'u_n_Path': 'data/movie20/U_neighbor.pickle',
                'i_n_Path': 'data/movie20/I_neighbor.pickle',
            ...
            'music': {
                ...
                'u_n_Path': 'data/music/U_neighbor.pickle',
                'i_n_Path': 'data/music/I_neighbor.pickle',
            ...
            'book': {
                ...
                'u_n_Path': 'data/book/U_neighbor.pickle',
                'i_n_Path': 'data/book/I_neighbor.pickle',
            ...
            'restaurant': {
                ...
                'u_n_Path': 'data/restaurant/U_neighbor.pickle',
                'i_n_Path': 'data/restaurant/I_neighbor.pickle',
            ...
            'yelp': {
                ...
                'u_n_Path': 'data/yelp/U_neighbor.pickle',
                'i_n_Path': 'data/yelp/I_neighbor.pickle',
            ...
            'movie1m': {
                ...
                'u_n_Path': 'data/movie1m/U_neighbor.pickle',
                'i_n_Path': 'data/movie1m/I_neighbor.pickle',
        ...
        with open(self.cfg[data]['u_n_Path'], 'rb') as f:
            u_n = pickle.load(f)
        with open(self.cfg[data]['i_n_Path'], 'rb') as f:
            i_n = pickle.load(f)
    ...
    def load_user_neighbor(self):
        return self.u_n

    def load_item_neighbor(self):
        return self.i_n
