...
class DataLoader:
    def __init__(self, data):
        self.cfg = {
            'movie20': {
                ...
                'r_n_Path': 'data/movie20/user_relations_interaction.pickle',
                'u_n_Path': 'data/movie20/item_users_interactive.pickle',
            ...
            'music': {
                ...
                'r_n_Path':'data/music/user_relations_interaction.pickle',
                'u_n_Path':'data/music/item_users_interactive.pickle',
            ...
            'book': {
                ...
                'r_n_Path': 'data/book/user_relations_interaction.pickle',
                'u_n_Path': 'data/book/item_users_interactive.pickle',
            ...
            'restaurant': {
                ...
                'r_n_Path': 'data/restaurant/user_relations_interaction.pickle',
                'u_n_Path': 'data/restaurant/item_users_interactive.pickle',
            ...
            'yelp': {
                ...
                'r_n_Path': 'data/yelp/user_relations_interaction.pickle',
                'u_n_Path': 'data/yelp/item_users_interactive.pickle',
            ...
            'movie1m': {
                ...
                'r_n_Path': 'data/movie1m/user_relations_interaction.pickle',
                'u_n_Path': 'data/movie1m/item_users_interactive.pickle',
        ...
        with open(self.cfg[data]['kgPath'], 'rb') as f:
            kg = pickle.load(f)
        with open(self.cfg[data]['r_n_Path'], 'rb') as f:
            uAndR = pickle.load(f)
        with open(self.cfg[data]['u_n_Path'], 'rb') as f:
            iAndU = pickle.load(f)
    ...
    def load_user_relations_interaction(self):
        return self.uAndR

    def load_item_users_interaction(self):
        return self.iAndU
